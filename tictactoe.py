...
def display_board(board: list):
    ...
    :param board: list to be transferred into board
    :return:
...
def game_starter(game_b, instruction_b):
    """
...
def player_choice(player: int, board: list):
    """
...
def space_check(board: list, choice: int):
    """
...
def player_marker(player: int, p1: str, p2: str):
    """
    ...
    :param p1: marker of player number 1
    :param p2: marker of player number 2
...
def place_marker(board: list, mark: str, pos: int):
    """
...
def main():
    ...
    # GAME STARTS HERE
    while start_game:
        game_started = game_starter(game_board, instruction_board)
        while game_started:
            ...
            while not game_status:
                ...
                marker = player_marker(current_player, p1_mark, p2_mark)
